...
import { Avatar, Button, LoadingOverlay, Stack, Text, Title } from "@mantine/core";
                ...
                {!loading && notifications.length > 0 && <>
                    <Stack>
                        ...
                        { notifications.map(({ link, title, message, updatedAt }) => <>
                            <Link to={link} className="flex gap-4 items-start py-4 border-b-2 border-slate-200 rounded focus:outline-none">
